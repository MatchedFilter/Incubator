...
/* USER CODE BEGIN PV */
Incubator incubator(INCUBATOR_VERSION);
/* USER CODE END PV */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, TC1602_RS_Pin|TC1602_RW_Pin|TC1602_EN_Pin|GPIO_PIN_4
                          |GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_RESET);

  /*Configure GPIO pins : TC1602_RS_Pin TC1602_RW_Pin TC1602_EN_Pin PA4
                           PA5 PA6 PA7 */
  GPIO_InitStruct.Pin = TC1602_RS_Pin|TC1602_RW_Pin|TC1602_EN_Pin|GPIO_PIN_4
